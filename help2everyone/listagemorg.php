...
if($_SERVER['REQUEST_METHOD']=='POST' && isset($_POST['Procurarvar']))
{
	...
	if($filtroselect==1){
			...
			$filtselnom="&& Email like '%".$filtronome."%'";
	}else if($filtroselect==4){
			$filtselnom="&& Website like '%".$filtronome."%'";
			...
			$filtselnom="&& DataReg like '%".$filtronome."%'";
	}else if($filtroselect==9){
			$filtselnom="&& DataFundacao like '%".$filtronome."%'";
}
}
...
<!--
				<div class="col-lg-8">
					<div class="courses_search_container">
						<form action="./listagemorg.php" method="POST" id="courses_search_form" class="courses_search_form d-flex flex-row align-items-center justify-content-start">
							...
							<select id="courses_search_select" name="tipo" class="courses_search_select courses_search_input">
								...
								<option value="3"<?php //if($filtroselect==3){echo "selected";} ?>>Email</option>
								<option value="4"<?php //if($filtroselect==4){echo "selected";} ?>>Website</option>
								<option value="5"<?php //if($filtroselect==5){echo "selected";} ?>>Pais</option>
							...
							<a style="padding-left:10px;" href="./listagemorg.php?limparsel" title="Limpar seleção"><i class="fa fa-refresh fa-2x"></i></a>
...
-->
						...
						<div class="col-lg-8">
							<div class="container" style="background-color:lightgrey;">
								<form action="./listagemorg.php" method="POST" id="courses_search_form" class="form-control" style="background-color:lightgrey;">
					...
					<div class="row" style="padding-top:15px;">
						<div class="col-md-6">
							...
							<form style="padding-top:5px;">
								<select name='order' <?php echo $hidden; ?> class="form-control" onchange='this.form.submit()'>
					...
					<div class="courses_container">
						...
						<div class="row courses_row">
							...
							if($filtareaatuacao!=null){
								$cmd=mysqli_query($conn,"select IdOrganizacao from tblareaatuacao where Nome='".$filtareaatuacao."'");
								$voltas=0;
								$info=array();
							...
							$cmd=mysqli_query($conn,"select Id from tblorganizacao where Aprovada=1 ".$filtselnom." order by Id ".$ordenar);
							$voltas=0;
							$info=array();
							while ($seg=mysqli_fetch_array($cmd)) {
							...
							if(!empty($tas)){
						for($i=0;$i<$tas;$i++){
							$result=mysqli_query($conn,"select * from tblorganizacao where Aprovada=1 && Id=".$info[$i]);
                ...
                $insta=htmlspecialchars($entrada['PagInstagram']);
								...
								$query=mysqli_query($conn,"select IdEvento from tblorgevento where IdOrganizacao=".$identity);
								$vol=0;
								$inf=array();
								...
								<div class='col-lg-6 course_col'>
									<div class='course'>
										...
										<div class='course_body'>
											<h3 class='course_title'><a href='listagemorg.php?open_org=".$nome."'>".$nome." ".$verif."</a></h3>
											<div class='course_teacher'>".$Email."</div>
                      ...
                      <span>Redes Sociais: </span>
                        ...
                        <a href='".$twt."' target='_blank' style='padding-right:5px;'><i class='fa fa-twitter' aria-hidden='true'></i></a>
												...
												<div class='course_price ml-auto'>".$ttevento." Eventos</div>
											</div>
										</div>
									</div>
								</div>";
            ...
            <div class="sidebar_section">
							...
							<div class="sidebar_categories">
								<ul>
									<li><a href="./listagemorg.php?but1">Ambiente</a></li>
									<li><a href="./listagemorg.php?but2">Cidadania e Direitos</a></li>
									<li><a href="./listagemorg.php?but3">Cultura e Artes</a></li>
									<li><a href="./listagemorg.php?but4">Desporto e Lazer</a></li>
									<li><a href="./listagemorg.php?but8">Educação</a></li>
									<li><a href="./listagemorg.php?but5">Novas Tecnologias</a></li>
									<li><a href="./listagemorg.php?but6">Saúde</a></li>
									<li><a href="./listagemorg.php?but7">Solidariedade Social</a></li>
								</ul>
							</div>
							<a class="btn btn-info" href="./listagemorg.php?butcerto">Perto de mim</a>
						</form>
						</div>
